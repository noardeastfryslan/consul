...
describe "Help page" do
  context "Index" do
    scenario "Help menu and page is visible if feature is enabled", :consul do
  ...
  scenario "does not render the SDG help page link when the feature is disabled", :consul do
